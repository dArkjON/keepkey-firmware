...
const pb_field_t TxOutputType_fields[8] = {
    ...
    PB_FIELD2(  7, ENUM    , OPTIONAL, STATIC  , OTHER, TxOutputType, address_type, op_return_data, 0),
    PB_LAST_FIELD
};
...
const pb_field_t TransactionType_fields[9] = {
    ...
    PB_FIELD2(  8, MESSAGE , OPTIONAL, STATIC  , OTHER, TransactionType, bookmark, outputs_cnt, &TxBookmark_fields),
    PB_LAST_FIELD
};
...
const pb_field_t TxBookmark_fields[3] = {
    PB_FIELD2(  1, BYTES   , OPTIONAL, STATIC  , FIRST, TxBookmark, sha256_ctx, sha256_ctx, 0),
    PB_FIELD2(  2, UINT32  , OPTIONAL, STATIC  , OTHER, TxBookmark, remaining_output_cnt, sha256_ctx, 0),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
STATIC_ASSERT((pb_membersize(HDNodePathType, node) < 65536 && pb_membersize(MultisigRedeemScriptType, pubkeys[0]) < 65536 && pb_membersize(TxInputType, multisig) < 65536 && pb_membersize(TxOutputType, multisig) < 65536 && pb_membersize(TransactionType, inputs[0]) < 65536 && pb_membersize(TransactionType, bin_outputs[0]) < 65536 && pb_membersize(TransactionType, outputs[0]) < 65536 && pb_membersize(TransactionType, bookmark) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_HDNodeType_HDNodePathType_CoinType_MultisigRedeemScriptType_TxInputType_TxOutputType_TxOutputBinType_TransactionType_TxRequestDetailsType_TxRequestSerializedType_IdentityType_TxBookmark)
#endif
