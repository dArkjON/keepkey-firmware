...
/* Generated by nanopb-0.2.9.2 at Tue May 17 18:23:05 2016. */
...
typedef struct {
    size_t size;
    uint8_t bytes[104];
} TxBookmark_sha256_ctx_t;

typedef struct _TxBookmark {
    bool has_sha256_ctx;
    TxBookmark_sha256_ctx_t sha256_ctx;
    bool has_remaining_output_cnt;
    uint32_t remaining_output_cnt;
} TxBookmark;
...
#define TransactionType_init_default             {false, 0, 0, {TxInputType_init_default}, 0, {TxOutputBinType_init_default}, false, 0, 0, {TxOutputType_init_default}, false, 0, false, 0, false, TxBookmark_init_default}
...
#define TxBookmark_init_default                  {false, {0, {0}}, false, 0}
...
#define TransactionType_init_zero                {false, 0, 0, {TxInputType_init_zero}, 0, {TxOutputBinType_init_zero}, false, 0, 0, {TxOutputType_init_zero}, false, 0, false, 0, false, TxBookmark_init_zero}
...
#define TxBookmark_init_zero                     {false, {0, {0}}, false, 0}
...
#define TxBookmark_sha256_ctx_tag                1
#define TxBookmark_remaining_output_cnt_tag      2
...
#define TransactionType_bookmark_tag             8
...
extern const pb_field_t TransactionType_fields[9];
...
extern const pb_field_t TxBookmark_fields[3];
